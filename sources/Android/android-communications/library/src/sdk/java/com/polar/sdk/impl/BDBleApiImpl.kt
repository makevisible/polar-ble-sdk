    ...
    override fun observeSleepRecordingState(identifier: String):  Flowable<Array<Boolean>> {
        ...
        val receive: Flowable<Array<Boolean>> =
            receiveRestApiEvents<PolarSleepApiServiceEventPayload>(identifier, mapper = { it.toObject() })
                .doOnSubscribe { BleLogger.d(TAG, "observeSleepRecordingState: Subscribed to receiveRestApiEvents") }
        ...
        return subscribe
            .doOnComplete { BleLogger.d(TAG, "observeSleepRecordingState: Subscription notification sent") }
            .andThen(receive)
